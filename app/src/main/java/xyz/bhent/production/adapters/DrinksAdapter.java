 ...
 */
public class DrinksAdapter extends BaseAdapter implements View.OnClickListener{
    ...
    public DrinksAdapter(Activity context, ArrayList<ItemModel> itemModels, Resources res){
    ...
    private class OnItemClickListener implements View.OnClickListener{
        ...
        public void onClick(View arg){
            Drinks blacknWhiteHome = (Drinks)context;
